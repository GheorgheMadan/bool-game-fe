...
//     const [searchQuery, setSearchQuery] = useState(searchParams.get('name') || ''); // Stato per il nome cercato
...
//     // Aggiorna i parametri di query quando cambia il filtro o la ricerca
//     useEffect(() => {
//         const params = {};
